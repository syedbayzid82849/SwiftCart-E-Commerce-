    ...
    products.forEach(product => {
        ...
        <div class="product-card bg-white rounded-2xl overflow-hidden border border-gray-100 flex flex-col">
            ...
            <div class="p-4 flex flex-col flex-1">
                ...
                <button onclick="modal.show(${JSON.stringify(product).replace(/\\/g, "\\\\").replace(/'/g, "\\'")})" class="flex-1 btn-primary flex items-center justify-center gap-1 text-white text-xs font-bold py-2 rounded-xl">
