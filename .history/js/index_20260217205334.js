...
const displayProductsByCategory = (products) => {
    ...
    products.forEach(product => {
        ...
        <button  class="flex-1 flex items-center justify-center gap-1.5 border border-gray-200 text-gray-700 text-xs font-semibold py-2.5 rounded-xl hover:bg-gray-50 transition">
